...
const glareBackground = useMotionTemplate`radial-gradient(circle at ${glareX}% ${glareY}%, rgba(255, 255, 255, 0.5) 10%, rgba(255, 255, 255, 0.25) 30%, rgba(255, 255, 255, 0) 70%)`;
...
function handlePointerEnter(e: PointerEvent) {
  ...
  zTarget.set(50);
  glareOpacityTarget.set(glareMax);
}
