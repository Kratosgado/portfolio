  ...
  >
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
      ...
      <div class="space-y-8">
        ...
        <div class="grid grid-cols-2 gap-4">
          <FloatingCard
            ...
            :translate-depth="8"
          >
            <div class="glass-card p-5 text-center h-full">
              <div
                :ref="
                  (el) => {
      ...
      <div class="grid grid-cols-2 gap-4 auto-rows-[120px]">
        ...
        >
          <div
            class="glass-card p-5 flex flex-col justify-between h-full group cursor-default hover:border-[var(--color-accent-start)]/30"
          >
